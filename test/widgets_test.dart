...
void main() {
  ...
  testWidgets('CtaButton.primary renders label and responds to tap', (
    tester,
  ) async {
    _useViewSize(tester, const Size(1280, 900));
    var tapped = false;
  ...
  testWidgets('ScrollReveal keeps child in tree and honors reduced motion', (
    tester,
  ) async {
    _useViewSize(tester, const Size(1280, 900));
    ...
    await tester.pumpWidget(
      MaterialApp(
        ...
        home: const MediaQuery(
          ...
          child: Scaffold(body: ScrollReveal(child: Text('revealed'))),
        ),
      ),
    );
  ...
  testWidgets('BentoCard renders name and category and opens on tap', (
    tester,
  ) async {
    _useViewSize(tester, const Size(1280, 900));
    ...
    // The whole card opens the case study directly.
