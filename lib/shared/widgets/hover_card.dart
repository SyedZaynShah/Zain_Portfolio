...
class HoverCard extends StatefulWidget {
  ...
  /// Corner radius of the lift shadow and the specular highlight clip — match
  /// this to the child's own radius so the highlight doesn't bleed past it.
  final double radius;

  final VoidCallback? onTap;

  /// Fired on hover enter/exit. Use this instead of a `MouseRegion` inside the
  /// child: this detection sits *outside* the tilt transform, so it doesn't
  /// thrash as the card tilts under the cursor (the source of hover flicker).
