      ...
      child: AnimatedBuilder(
        ...
        builder: (context, child) {
          ...
          return Stack(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsets.only(left: yearWidth + 32 + Spacing.md),
                child: child,
              ),
              if (!isMobile)
                Positioned(
                  ...
                  child: Opacity(
                    ...
                    child: Text(
                      '${widget.event.year}',
                      style: AppTypography.monoAccent.copyWith(fontSize: 14),
                    ),
                  ),
                ),
        ...
        child: Padding(
          ...
          child: ScrollReveal(
            ...
            offset: 40,
            child: _EventCard(event: widget.event),
          ),
        ),
      ),
    );
...
class _EventCardState extends State<_EventCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final expanded =
        _hovered || !context.supportsHover || context.reducedMotion;
    ...
    return MouseRegion(
      ...
      child: Semantics(
        label:
            '${event.year}: ${event.title}${event.company == null ? '' : ' at ${event.company}'}',
        child: AnimatedContainer(
          // Matches the icon rotation and expand size so the whole card
          // resolves as one motion.
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: expanded ? AppColors.borderActive : AppColors.borderSubtle,
            ),
          ),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
                ...
                children: [
                  ...
                  AnimatedRotation(
                    ...
                    child: Icon(
                      ...
                      size: 16,
                      color:
                          expanded ? AppColors.textAccent : AppColors.textMuted,
                    ),
                  ),
                ],
              ),
