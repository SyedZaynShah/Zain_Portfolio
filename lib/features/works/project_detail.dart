                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                '· ${_platformLabel(project.platform)}',
                          ...
                          Text(
                            ...
                            style: context.responsive(
                              ...
                              desktop: AppTypography.displayL,
                            ),
                          ),
                          ...
                          _Flow(
                            ...
                            right: _MetaCard(
                              project: project,
                              platformLabel: _platformLabel(project.platform),
                            ),
                          ),
                            ...
                            _Flow(
                              ...
                              right: _Labelled(
                                ...
                                child: Wrap(
                                  ...
                                  children: [
                                    for (final t in project.tech) TechBadge(t),
                                  ],
                                ),
                              ),
                            ),
                          ...
                          _NextProjectCard(
                            next: _next,
                            onTap: () => context.go('/work/${_next.id}'),
                          ),
                          const SizedBox(height: Spacing.xxl),
                        ],
                      ),
...
class _Flow extends StatelessWidget {
  const _Flow({required this.left, required this.right});
  ...
  Widget build(BuildContext context) {
    ...
    return Flex(
      ...
      children: [
        ...
        SizedBox(
          width: mobile ? 0 : Spacing.xxl,
          height: mobile ? Spacing.xl : 0,
        ),
      ...
      child: Column(
        ...
        children: [
          for (var i = 0; i < rows.length; i++) ...[
            ...
            Text(rows[i].$1.toUpperCase(), style: AppTypography.monoSm),
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
      ...
      gradient: RadialGradient(
        ...
        radius: 2,
        colors: [
          project.dominantColor.withValues(alpha: 0.18),
          Colors.transparent,
        ],
      ),
    ),
            ...
            child: Column(
              ...
              children: [
                CountUpText(
                  ...
                  style: context
                      .responsive(
                        mobile: AppTypography.titleL,
                        desktop: AppTypography.displayM,
                      )
                      .copyWith(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                color:
                    _hovered ? widget.next.accentColor : AppColors.surfaceCard,
                border: Border.all(
                  color:
                      _hovered
                          ? widget.next.accentColor
          ...
          child: GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: _active ? widget.accent : AppColors.borderSubtle,
                ),
              ),
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  ...
                  Text(
                    widget.label,
                    style: AppTypography.titleS.copyWith(fontSize: 14),
                  ),
                ],
              ),
            ),
    ...
    child: MouseRegion(
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            shape: BoxShape.circle,
            color: _active ? AppColors.accentPrimary : AppColors.surfaceCard,
            border: Border.all(
              color: _active ? AppColors.accentPrimary : AppColors.borderSubtle,
            ),
          ),
          child: Icon(
            LucideIcons.x,
            size: 18,
            color: _active ? AppColors.textOnAccent : AppColors.textPrimary,
          ),
        ),
      ),
    ),
...
class _CaseStudyMedia extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final p = project;
    final galleryH = context.responsive<double>(
      mobile: 320,
      tablet: 460,
      desktop: 540,
    );
    ...
    final content =
        p.hasImages
            ? _CaseStudyGallery(project: p)
            : ClipRRect(
              borderRadius: BorderRadius.circular(Radii.lg),
              child: AbstractArtPanel(project: p),
            );

    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        SizedBox(height: galleryH, child: content),
        if (p.hasPrototype) ...[
          const SizedBox(height: Spacing.md),
...
/// Pill that opens the live prototype in a dedicated fullscreen view.
class _LaunchPrototypeButton extends StatefulWidget {
  const _LaunchPrototypeButton({required this.accent, required this.onTap});

  final Color accent;
  final VoidCallback onTap;

  @override
  State<_LaunchPrototypeButton> createState() => _LaunchPrototypeButtonState();
}

class _LaunchPrototypeButtonState extends State<_LaunchPrototypeButton> {
  bool _hovered = false;
  bool _focused = false;
          ...
          child: GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Icon(LucideIcons.pointer, size: 16, color: widget.accent),
                  const SizedBox(width: Spacing.sm),
                  Text(
                  ...
                  Icon(
                    ...
                    size: 16,
                    color: _active ? widget.accent : AppColors.textMuted,
                  ),
                ],
              ),
            ),
...
/// Dedicated fullscreen view of a live HTML prototype — the Back button or Esc
/// dismisses it.
class _LivePrototypePage extends StatelessWidget {
  const _LivePrototypePage({
    required this.url,
    required this.title,
    required this.accent,
  });
    ...
    child: Focus(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: Column(
            children: [
              // Control bar. It sits *above* the iframe (not overlaid on it):
              // a Flutter widget drawn over an HtmlElementView iframe never
              // receives pointer events on web, so an overlaid close button
              // would be unclickable — this bar always is.
              DecoratedBox(
...
/// Labelled "Back" control for the fullscreen prototype bar.
class _ProtoBackButton extends StatefulWidget {
  const _ProtoBackButton({required this.onTap});

  final VoidCallback onTap;

  @override
  State<_ProtoBackButton> createState() => _ProtoBackButtonState();
}

class _ProtoBackButtonState extends State<_ProtoBackButton> {
  bool _hovered = false;
  bool _focused = false;
        ...
        child: MouseRegion(
          ...
          child: GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: _active ? AppColors.surfaceCard : Colors.transparent,
                borderRadius: BorderRadius.circular(Radii.pill),
                border: Border.all(
                  color:
                      _active ? AppColors.borderActive : AppColors.borderSubtle,
                ),
              ),
              child: Row(
                mainAxisSize: MainAxisSize.min,
            ...
            child: DecoratedBox(
              decoration: BoxDecoration(
                gradient: RadialGradient(
                  ...
                  radius: 1.5,
                  colors: [
                    widget.project.dominantColor.withValues(alpha: 0.3),
                    AppColors.inkBlack,
                  ],
                ),
              ),
