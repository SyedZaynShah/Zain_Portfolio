    ...
    return MouseRegion(
      ...
      child: Stack(
        ...
        children: [
          ...
          // ambiance and ties the hero to the rest of the site. Dimmed via
          // opacityScale rather than an Opacity layer (which would force a
          // full-viewport saveLayer every frame); ParticleField is internally
          // IgnorePointer, so hover still reaches the ancestor region.
          const Positioned.fill(
            child: ParticleField(count: 26, opacityScale: 0.5),
          ),
          SafeArea(
            child: Padding(
              ...
              child: AnimatedBuilder(
                ...
                builder:
                    (context, _) => Center(
                      child: Opacity(
                        opacity: _beat(1100, 1200),
                        child: RepaintBoundary(child: _ScrollHint(loop: _loop)),
                      ),
                    ),
              ),
            ),
