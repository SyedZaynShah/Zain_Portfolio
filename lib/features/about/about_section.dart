...
import 'package:polymorphism/features/about/simple_portrait.dart';
...
///
/// Desktop: the portrait image on the left, bio on the right; skills grid + 
/// stats below. Mobile: everything stacks.
class AboutSection extends StatelessWidget {
  ...
  Widget _wideLayout(BuildContext context) => Row(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      const Expanded(flex: 2, child: SimplePortrait()),
  ...
  Widget _mobileLayout(BuildContext context) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      const Center(child: SizedBox(width: 280, child: SimplePortrait())),
  ...
  Widget _bioAndSkills(BuildContext context) => Column(
    ...
    children: [
      ...
      if (AppStrings.aboutBioSecond.isNotEmpty) ...[
        const SizedBox(height: Spacing.md),
