...
class _FragmentPortraitState extends State<FragmentPortrait>
  ...
  double _fragProgress(int order) {
    ...
    return AppCurves.spring.transform(
      _assemble.value.subProgress(start, start + span).clamp(0.0, 1.0),
    );
  }

  @override
  Widget build(BuildContext context) {
    // Hover-driven assembly is skipped under reduced motion — the portrait is
    // pinned assembled in didChangeDependencies, so wiring the MouseRegion
    // would let an exit scatter it and leave it disassembled.
                      ...
                      if (interactive)
                        Positioned(
                          ...
                          child: IgnorePointer(
                            child: Opacity(
                              opacity:
                                  (1 - _assemble.value).clamp(0.0, 1.0) * 0.8,
                              child: Center(
                                child: Text(
                                  'hover to assemble',
      ...
      child: Opacity(
        ...
        child: Transform.rotate(
          ...
          child: DecoratedBox(
            ...
            child: Image.asset(
              'assets/images/fragment${f.asset}.webp',
              fit: BoxFit.contain,
            ),
          ),
        ),
