...
class ToolkitSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ScrollReveal(
          child: Text(AppStrings.skillsLabel, style: AppTypography.monoAccent),
        ),
        const SizedBox(height: Spacing.lg),
        for (var i = 0; i < pillars.length; i++) ...[
          ScrollReveal(
            delay: Duration(milliseconds: i * 90),
            child: _PillarCard(pillar: pillars[i]),
          ),
    ...
    final card = MouseRegion(
      ...
      child: Semantics(
        ...
        child: AnimatedContainer(
          ...
          transform:
              active ? Matrix4.translationValues(4, 0, 0) : Matrix4.identity(),
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(Radii.lg),
            border: Border.all(
              color:
                  active
                      ? pillar.accent.withValues(alpha: 0.5)
            ...
            gradient: LinearGradient(
              colors: [
                Color.lerp(
                  ...
                  pillar.accent.withValues(alpha: 0.14),
                  active ? 1 : 0.4,
                )!,
                AppColors.surfaceCard,
              ],
            ...
            boxShadow:
                active
                    ? [
                      BoxShadow(
                        color: pillar.accent.withValues(alpha: 0.16),
                        blurRadius: 30,
                ...
                Positioned(
                  ...
                  child: IgnorePointer(
                    child: Icon(
                      pillar.icon,
                      size: 96,
                      color: pillar.accent.withValues(
                        alpha: active ? 0.12 : 0.05,
                      ),
                    ),
                  ),
                ),
                      ...
                      AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          ...
                          color:
                              active
                                  ? pillar.accent
                                  : pillar.accent.withValues(alpha: 0.12),
                          border: Border.all(
                            color: pillar.accent.withValues(
                              alpha: active ? 1 : 0.3,
                            ),
                        ...
                        child: Icon(
                          ...
                          size: 26,
                          color:
                              active ? AppColors.textOnAccent : pillar.accent,
                        ),
                      ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Wrap(
                              ...
                              children: [
                                for (final skill in pillar.skills)
                                  _ToolChip(
                                    skill: skill,
...
class _ToolChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) => AnimatedContainer(
    ...
    decoration: BoxDecoration(
      ...
      border: Border.all(
        color: active ? accent.withValues(alpha: 0.35) : AppColors.borderSubtle,
      ),
    ),
    child: Row(
