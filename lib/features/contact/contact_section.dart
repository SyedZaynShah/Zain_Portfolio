...
class _ContactSectionState extends State<ContactSection> {
  ...
  Future<void> _mailtoFallback() async {
    ...
    try {
      if (await canLaunchUrl(uri)) {
        ...
        if (mounted) {
          _notify(
            AppStrings.contactMailFallback,
            LucideIcons.mail,
              ...
              isMobile
                  ...
                  : Row(
                    ...
                    children: [
                      ...
                      // Horizontal gutter — the section token is vertical rhythm;
                      // xxxl matches the column gap used elsewhere.
  ...
  Widget _intro(BuildContext context) => Column(
    ...
    children: [
      ...
      const ScrollReveal(
        child: AvailabilityBadge(label: AppStrings.contactAvailability),
      ),
      const SizedBox(height: Spacing.lg),
      ScrollReveal(
        delay: AppDurations.instant,
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: const InputDecoration(
            labelText: AppStrings.contactMessageLabel,
            alignLabelWithHint: true,
          ),
          validator:
              (v) =>
                  (v == null || v.trim().isEmpty)
                      ? AppStrings.errMessageRequired
                      : null,
        ),
        const SizedBox(height: Spacing.lg),
        Align(
  ...
  TextFormField _nameField() => TextFormField(
    ...
    validator:
        (v) =>
            (v == null || v.trim().isEmpty) ? AppStrings.errNameRequired : null,
  );
  ...
  TextFormField _emailField() => TextFormField(
    ...
    validator: (v) {
      ...
      return EmailService.isValidEmail(v.trim())
          ? null
          : AppStrings.errEmailInvalid;
    },
  );
      ...
      Wrap(
        ...
        children: [
          for (final social in PortfolioData.socials)
            _DirectLink(label: social.label, url: social.url),
        ],
      ),
    ],
  );
            ...
            children: [
              Text(
                ...
                style: AppTypography.bodyM.copyWith(
                  color:
                      _hovered ? AppColors.textAccent : AppColors.textPrimary,
                ),
              ),
              AnimatedContainer(
