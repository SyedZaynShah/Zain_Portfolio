...
class TypographyTokens {
  ...
  static const double button = 15; // Interactive control labels (Space Grotesk)
  ...
  static const double monoLg = 14; // Larger utility mono — prominent meta
  static const double monoNav = 13; // Nav / inline mono links
  static const double mono = 12; // Utility mono — badges, numbers
  static const double monoSm = 10; // Smallest utility mono — dense meta
...
class AppColors {
  ...
  static const Color accentSubtle = Color(
    0x2000F5C4,
  ); // 12.5% accent (subtle bg)
  ...
  static const Color textMuted = Color(
    0xFF7878A0,
  ); // Muted / placeholders (~4.7:1 on deepSpace)
