...
class AppTypography {
  ...
  static TextStyle get titleM => GoogleFonts.spaceGrotesk(
    ...
    fontWeight: FontWeight.w600,
    letterSpacing: TypographyTokens.titleM * TypographyTokens.trackedTight,
    height: 1.2,
    color: AppColors.textPrimary,
  );
  ...
  static TextStyle get titleS => GoogleFonts.spaceGrotesk(
    ...
    fontWeight: FontWeight.w600,
    letterSpacing: TypographyTokens.titleS * TypographyTokens.trackedTight,
    height: 1.3,
    color: AppColors.textPrimary,
  );

  /// Interactive control label — the one size for CTA/button text.
  static TextStyle get button => GoogleFonts.spaceGrotesk(
    fontSize: TypographyTokens.button,
    fontWeight: FontWeight.w600,
    letterSpacing: TypographyTokens.button * TypographyTokens.trackedTight,
    height: 1.2,
    color: AppColors.textPrimary,
  );
  ...
  /// Smallest utility mono — dense meta chips.
  static TextStyle get monoSm => GoogleFonts.jetBrainsMono(
    fontSize: TypographyTokens.monoSm,
    fontWeight: FontWeight.w500,
    letterSpacing: TypographyTokens.monoSm * TypographyTokens.trackedWide,
    height: 1.4,
    color: AppColors.textMuted,
  );

  /// Nav / inline mono links — 13px with tracking derived from its own size.
  static TextStyle get monoNav => GoogleFonts.jetBrainsMono(
    fontSize: TypographyTokens.monoNav,
    fontWeight: FontWeight.w500,
    letterSpacing: TypographyTokens.monoNav * TypographyTokens.trackedWide,
    height: 1.4,
    color: AppColors.textSecondary,
  );

  /// Larger utility mono — prominent meta and stat units.
  static TextStyle get monoLg => GoogleFonts.jetBrainsMono(
    fontSize: TypographyTokens.monoLg,
    fontWeight: FontWeight.w500,
    letterSpacing: TypographyTokens.monoLg * TypographyTokens.trackedWide,
    height: 1.35,
    color: AppColors.textSecondary,
  );
